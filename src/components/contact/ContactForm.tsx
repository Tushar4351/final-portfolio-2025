        ...
        <form onSubmit={sendEmail} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <input
                ...
                className="w-full p-3 rounded-lg border bg-white border-gray-200 focus:outline-none focus:border-gray-400 transition-colors"
                required
          ...
          >
            <textarea
              ...
              onChange={handleChange}
              className="w-full p-3 rounded-lg border bg-white border-gray-200 focus:outline-none focus:border-gray-400 transition-colors min-h-[150px] resize-none"
              required
              disabled={isSubmitting}
            />
          </motion.div>

...
import { SlidingText } from "../animations/SlidingTextLogoEffect";
import { hamburgerLineVariants, menuVariants } from "@/data/animations";
import Link from "next/link";
import Image from "next/image";
import GlowNavigation from "../animations/GlowNavigation";
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className={`text-white text-2xl w-auto h-auto font-bold`}
            >
              <Link href="/">
                <SlidingText
                  firstText="Tushar"
                ...
                <div className="flex flex-col space-y-4 mt-4">
                  <AnimatePresence mode="wait">
                    <motion.a
                      ...
                      animate="visible"
                      exit="exit"
                      className="shadow-[0_0_0_3px_#000000_inset] px-4 py-[0.5rem] bg-transparent border-2 border-white text-white rounded-lg font-bold transform hover:-translate-y-1 transition duration-400 flex items-center justify-center gap-2"
                    >
                      Contact Me
                      <span>
                        <Image
          ...
          <div className="hidden lg:flex text-lg font-medium items-center gap-4">
            <motion.a
              href="/contact"
              whileHover={{ scale: 1.05 }}
              className="shadow-[0_0_0_3px_#000000_inset] px-4 py-[0.3rem] bg-transparent border-2 border-white text-white rounded-lg transform hover:-translate-y-1 transition duration-400 flex items-center justify-center gap-2"
            >
              Contact Me
              <span>
                <Image
